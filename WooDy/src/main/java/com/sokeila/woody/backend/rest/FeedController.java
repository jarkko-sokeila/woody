...
public class FeedController {
    ...
    private final IPHashRepository ipHashRepository;

    public FeedController(FeedRepository feedRepository, IPHashRepository ipHashRepository) {
		this.feedRepository = feedRepository;
		this.ipHashRepository = ipHashRepository;
    }
	...
	public ResponseEntity<Long> getUnreadCount(@RequestParam(name = "category", required = false) Category category, @RequestParam(name = "datetime") String dateTime) {
        ...
        log.debug("UnreadCount after date {} in category {} is {}", dateToString(date), category, unreadCount);
	...
	public void addFeed(@RequestParam(name = "category", required = false) Category category) {
		...
		entity.setLink("https://www.google.com");
